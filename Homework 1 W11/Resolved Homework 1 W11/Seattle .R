...
library(tidyverse)
df <- read_csv("https://raw.githubusercontent.com/daniel-dc-cd/data_science/master/module_4_ML/data/seattle_weather_1948-2017.csv")
df[is.na(df)]<-0
...
for(z in seq(1,nrow(df)-2,1)) {
  ...
  if( heuristic_df[z,2] == heuristic_df[z,3]){
